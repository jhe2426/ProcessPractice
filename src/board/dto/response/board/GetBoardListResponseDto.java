...
public class GetBoardListResponseDto {
	...
	public static List<GetBoardListResponseDto> copyList(List<Board> boardList) {//Entity -> Dto
		List<GetBoardListResponseDto> result = new ArrayList<GetBoardListResponseDto>();
